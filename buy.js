...
var preco_0, preco_1, preco_2, preco_3, preco_4, preco_5, preco_6, preco_compra;
...
var venda_preco_0, venda_quantidade_0, valor_quantidade_0;
var client = Binance({
    apiKey: api_key,
...
function livro() {
    return __awaiter(this, void 0, void 0, function () {
        var url, data, livroDataBuying, livroDataSelling, posicao_0, posicao_1, posicao_2, posicao_3, posicao_4, posicao_5, posicao_6, venda_posicao_0, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 6:
                    ...
                    posicao_0 = (livroDataBuying[0]);
                    posicao_1 = (livroDataBuying[1]);
                    posicao_2 = (livroDataBuying[2]);
                    posicao_3 = (livroDataBuying[3]);
                    posicao_4 = (livroDataBuying[4]);
                    posicao_5 = (livroDataBuying[5]);
                    posicao_6 = (livroDataBuying[6]);
                    ...
                    venda_posicao_0 = (livroDataSelling[0]);
...
function Status() {
    return __awaiter(this, void 0, void 0, function () {
        var url, data, responseStatusData, error_6;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 7, , 8]);
                    url = "https://api.bitcointrade.com.br/v3/market/user_orders/".concat(id_compra);
                    return [4 /*yield*/, axios.get(url, {
                            headers: headers
                        })];
                case 1:
...
function estrategia() {
    return __awaiter(this, void 0, void 0, function () {
        var contador, protecao, preco_global, saldo, ultima_compra, preco_global1, status, error_7;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 2:
                    saldo = _a.sent();
                    if (!(saldo && saldo < 20)) return [3 /*break*/, 6];
                ...
                case 15:
                    ...
                    if (!(ultima_compra > preco_compra)) return [3 /*break*/, 18];
                    return [4 /*yield*/, cancelarOrder()];
                case 16:
                    _a.sent();
                    return [4 /*yield*/, compra()];
                ...
                case 18:
                    ...
                    if (!(preco_compra > preco_global1)) return [3 /*break*/, 21];
                    return [4 /*yield*/, cancelarOrder()];
                case 19:
                    _a.sent();
                    return [4 /*yield*/, compra()];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, axios.delete(url, { headers: headers, data: { code: id_compra } })];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 3];
                case 2:
...
function ordens() {
    return __awaiter(this, void 0, void 0, function () {
        var url_executed_partially, dataExecutedPartially, userOrdersOpenExecutedPartially, error_9;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 4, , 5]);
                    url_executed_partially = "https://api.bitcointrade.com.br/v3/market/user_orders/open?pair=".concat(Moeda, "&status=executed_partially&type=buy");
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    error_10 = _a.sent();
                    console.log("\n*** ERRO EXCEPTION ***");
                    console.error('Erro no backend:', error_10);
                    return [3 /*break*/, 5];
